...
import { ArrowLeft, HeartPulse, Thermometer } from 'lucide-react';
   ...
   <div className="flex flex-1 flex-col bg-[#f8fafc] dark:bg-zinc-950 min-h-screen">
      <div className="mx-auto w-full max-w-2xl px-4 pt-8 md:px-0">
        <Button variant="ghost" size="sm" asChild className="-ml-2 text-muted-foreground hover:text-foreground">
          <Link href="/temperature" className="flex items-center gap-2">
            <ArrowLeft className="h-4 w-4" />
            <span>Back to Temperature Records</span>
          </Link>
        </Button>
      </div>
          ...
          <div className="mb-8 flex flex-col items-center text-center space-y-3">
            ...
            <div className="space-y-1">
              ...
              <p className="text-sm text-muted-foreground">
                Enter your latest temperature reading to keep your Master log up to date.
              </p>
            </div>
          </div>
