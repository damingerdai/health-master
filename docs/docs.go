...
const docTemplate = `{
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/model.VerifyLoginRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "name": "RequestResetInput",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/model.RequestResetInput"
                        }
                    }
                ],
                "responses": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "name": "ResetPasswordSubmitInput",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/model.ResetPasswordSubmitInput"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "model.ResetPasswordSubmitInput": {
            "type": "object",
            "required": [
                "confirm_password",
                "email",
